 ...
 *  USA
 *
 *  $Id: m_links.c,v 1.3 2003/05/24 00:07:45 demond Exp $
 */
 ...
 */
  ...
  sendto_one(source_p, form_str(source_p,RPL_LINKS),
                           me.name, parv[0], me.name, me.name,
                           0, me.info);
      
  sendto_one(source_p, form_str(source_p,RPL_ENDOFLINKS), me.name, parv[0], "*");
}
