 ...
 *  USA
 *
 *  $Id: m_version.c,v 1.3 2003/05/24 00:07:45 demond Exp $
 */
                      ...
                      int parc, char* parv[])
{
  ...
  sendto_one(source_p, form_str(source_p,RPL_VERSION), me.name,
                      ...
                      int parc, char* parv[])
{
  ...
  sendto_one(source_p, form_str(source_p,RPL_VERSION), me.name, parv[0], ircd_version, 
...
static char* confopts(struct Client *source_p)
{
  ...
  *p++ = 'D';
  ...
  if (ConfigFileEntry.drone_kline)
	*p++ = ConfigFileEntry.drone_batch? 'k' : 'K';
