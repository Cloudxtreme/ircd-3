 ...
 *  USA
 *
 *  $Id: m_accept.c,v 1.2 2003/03/10 06:09:00 demond Exp $
 */
                    ...
                    int parc, char *parv[])
{
      ...
      nick = strtoken(&p, NULL, ","))
  {
    ...
    {
      sendto_one(source_p, form_str(source_p,ERR_ACCEPTNOT),
      ...
      nick = strtoken(&p, NULL, ","), accept_num++)
  {
    ...
    if(accept_message(target_p, source_p))
    {
      sendto_one(source_p, form_str(source_p,ERR_ACCEPTEXIST),
                 me.name, source_p->name, target_p->name);
      continue;
    }
    ...
    {
      sendto_one(source_p, form_str(source_p,ERR_ACCEPTFULL),
  ...
  *nicks = '\0';
  ...
  DLINK_FOREACH(ptr, source_p->allow_list.head)
  {
    ...
    if(target_p)
    {
      ...
      {
        sendto_one(source_p, form_str(source_p,RPL_ACCEPTLIST),
  ...
  sendto_one(source_p, form_str(source_p,RPL_ENDOFACCEPT),
             me.name, source_p->name);
