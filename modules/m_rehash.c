 ...
 *  USA
 *
 *  $Id: m_rehash.c,v 1.2 2003/03/10 06:09:01 demond Exp $
 */
  ...
  if (parc > 1)
    {
      if(irccmp(parv[1],"DNS") == 0)
        {
          sendto_one(source_p, form_str(source_p,RPL_REHASHING), me.name, parv[0], "DNS");
    ...
    {
      sendto_one(source_p, form_str(source_p,RPL_REHASHING), me.name, parv[0],
