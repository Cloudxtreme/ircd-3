 ...
 *  USA
 *
 *  $Id: m_kick.c,v 1.3 2003/05/24 00:07:46 demond Exp $
 */
                  ...
                  char *parv[])
{
  ...
  *buf = '\0';
  ...
  if (IsMember(who, chptr))
...
#endif
	  if (find_z_conf((char *)who->user->server) && !IsOper(source_p)) {
		  sendto_one(source_p, form_str(source_p,ERR_CANTKICKSERVICES),
    ...
    sendto_one(source_p, form_str(source_p,ERR_USERNOTINCHANNEL),
