 ...
 *  USA
 *
 *  $Id: s_conf.h,v 1.4 2003/05/24 00:07:44 demond Exp $
 */
...
/* additional client flag */
#define CONF_FLAGS_MASKHOST             0x00100000
#define CONF_FLAGS_SKIPFAIL             0x00200000
...
#define IsConfMaskHost(x)       ((x)->flags & CONF_FLAGS_MASKHOST)
#define IsConfSkipOnPassFail(x) ((x)->flags & CONF_FLAGS_SKIPFAIL)
...
#define MAXNETID 	6
#define MAXDREASON 120
#define REPGRACEDEF 20
...
struct config_file_entry
{
  ...
  char netid[MAXNETID + 1];
  char drone_reason[MAXDREASON + 1];
  char spawn_pass[PASSWDLEN + 1];
  ...
  int         drone_batch;
  int         drone_rate_max;
  int         drone_rate_period;
  int         drone_kline_time;
...
extern int find_z_conf(char *);
extern void report_zlines(struct Client* client_p);
extern void report_equivs(struct Client* client_p);
extern void add_equiv_nicks(char *);
extern char *get_equiv_nick(char *, char *);
extern void add_userpar_param(char *);
extern void report_userparms(struct Client *);
extern int IsUserPar(char *, char *);
extern void add_relay_server(char *);
extern void report_relays(struct Client *);
extern int IsRelay(struct Client *);
extern void add_cluster_bridge(char *);
extern void report_clusters(struct Client *);
extern char *get_bridge_token(struct Client *);
extern int HasBridgeToken(char *);
extern void conf_add_z_conf(struct ConfItem *);
