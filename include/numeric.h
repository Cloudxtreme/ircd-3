 ...
 *  USA
 *
 *  $Id: numeric.h,v 1.5 2003/05/24 00:07:44 demond Exp $
 */
 ...
 */
extern char* form_str(struct Client *, int);
...
#define RPL_STATSZLINE	     227 /* configured services line */
#define RPL_EQUIVALENTS      228 /* configured equivalent nicks */
#define RPL_RELAYS           229 /* configured relays (bnet ext) */
#define RPL_USERPARMS        230 /* configured recognizable USER pars */
#define RPL_CLUSTERBRIDGE    231 /* configured cluster bridges */
...
#define RPL_WHOISCYRILLIC    298 /* this nick is cyrillic-encoded */
#define RPL_NONE             300
#define RPL_AWAY             301
...
#define RPL_WHOISSVSHINT     326 /* identified with services */
#define RPL_WHOISREALHOST    327 /* real client host */
...
#define RPL_SUBSTLIST		 344 /* word subst list */
#define RPL_ENDOFSUBSTLIST   345 /* eol */
...
#define RPL_DENYLIST         377
#define RPL_ENDOFDENYLIST    378
...
#define ERR_NOREPEATING      452 /* no repeating allowed */
...
#define ERR_CANNOTSENDNOTREG 468	/* only reg nicks may speak */
#define ERR_REGNICKSCHAN     469    /* channel is for reg nicks only */
#define ERR_NOCYRNICKCHAN    470    /* no cyrillic nicks allowed */ 
...
#define ERR_CANTKICKSERVICES 486
#define ERR_CANTDEOPSERVICES 487
...
#define ERR_REGACCEPTONLY    499        /* accepting from reg nicks only */
