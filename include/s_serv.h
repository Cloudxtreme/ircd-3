 ...
 *  USA
 *
 *  $Id: s_serv.h,v 1.2 2003/03/10 06:09:00 demond Exp $
 */
...
#define CAP_DENY        0x00000004   /* Can do gecos & channame bans */
...
#define CAP_SW			0x00000080	 /* Can do word substitutes */
...
#define CAP_HOSTMASK	0x00100000	 /* Can do host masking */
#define CAP_SVS         0x00200000   /* Can do SVS commands */
#define CAP_IP          0x00400000   /* Can do IP relay */

#define CAP_MASK        (CAP_QS       | CAP_EX   | CAP_CHW  | \
                         CAP_IE       | CAP_EOB  | CAP_KLN  | \
                         CAP_GLN      | CAP_HOPS | CAP_AOPS | \
                         CAP_UID      | CAP_ZIP  | CAP_ENC  | \
                         CAP_KNOCK    | CAP_PARA | CAP_SW   | \
                         CAP_HOSTMASK | CAP_SVS  | CAP_IP   | \
                         CAP_DENY)
